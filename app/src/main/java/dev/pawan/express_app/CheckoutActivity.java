...
import dev.pawan.express_app.adapters.CartAdapter;
import dev.pawan.express_app.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CartAdapter(this, products, () ->
                binding.subtotal.setText(String.format("₹ %s",cart.getTotalPrice())
                ));
        ...
        binding.total.setText(String.format("₹%s", totalPrice));
